...
@Component({
  selector: 'lnr-settings-profile-invoice-address',
  templateUrl: './settings-profile-invoice-address.component.html',
  styleUrls: ['./settings-profile-invoice-address.component.scss']
})
export class SettingsProfileInvoiceAddressComponent implements OnInit {
