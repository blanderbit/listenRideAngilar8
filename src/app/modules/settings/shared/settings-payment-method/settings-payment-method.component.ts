...
@Component({
  ...
  styleUrls: ['../settings-form.scss', './settings-payment-method.component.scss']
})
export class SettingsPaymentMethodComponent implements OnInit {
  ...
  private getForm(): FormGroup {
    const formControls = {
      ...
      type: ['scheme'],
      holderName: [],
      creditCard: ['', [CreditCardValidator.validateCCNumber as any, Validators.required]],
      expDate: ['', [CreditCardValidator.validateExpDate as any, Validators.required]],
