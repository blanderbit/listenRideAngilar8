...
export class AuthService {
  ...
  signUpFB(signUpFacebookRequest: SignUpFacebookRequest, companyName = null): Observable<User> {
  ...
  getUser(oauthTokenRequest: OauthTokenRequest | OauthTokenFacebookRequest, companyName = null): Observable<User> {
    return this.apiOauthService.token(oauthTokenRequest)
      .pipe(
        ...
        exhaustMap((user: User) => {
          ...
          if (companyName) {
            ...
            return this.apiBusinessService.create(businessCreateRequest)
              .pipe(
                map(() => {
  ...
  saveTokens(oauthTokenResponse: OauthTokenResponse) {
    localStorage.setItem(TokensEnum.ACCESS_TOKEN, oauthTokenResponse.access_token);
    localStorage.setItem(TokensEnum.REFRESH_TOKEN, oauthTokenResponse.refresh_token);
