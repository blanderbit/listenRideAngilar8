...
export const getMeSuccess = createAction('[User/API] Get Me Success', props<{ me: Partial<User> }>());
export const getMeFailure = createAction('[User/API] Get Me Failure', props<{ error: HttpErrorResponse }>());
